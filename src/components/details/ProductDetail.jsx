...
const ProductDetail = () => {
  ...
  return (
    <div className="w-screen h-screen z-50 top-0 left-0 fixed bg-black bg-opacity-30 flex items-center justify-center overflow-scroll">
      <div className="w-screen h-screen z-50 top-0 left-0 fixed bg-black bg-opacity-30 flex items-center justify-center overflow-scroll">
        <div className="scale-up-center md:px-10 py-8 w-11/12 h-fit bg-white rounded-md shadow-lg">
          <button
          ...
          <div className="max-w-full flex flex-col md:flex-row gap-8 px-8 py-5 mt-5 overflow-y-auto">
